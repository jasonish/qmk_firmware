...
/* Keep the first 4 in order so the Mac/Windows switch works. */
enum layers {
    MAC_BASE,
    MAC_FN,
    WIN_BASE,
...
#define LAYOUT_WRAPPER(...) LAYOUT_ansi_90(__VA_ARGS__)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_90(
        ...
        CW_TOGG,    KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,          KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_PGDN,
        _______,    KC_LCTL,  _A,       _S,       _D,       _F,       KC_G,          KC_H,     _J,       _K,       _L,       _SCLN,    KC_QUOT,            KC_ENT,             KC_HOME,
        _______,    KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,          KC_B,     KC_B   ,  KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
        _______,    KC_LCTL,  KC_LALT,            KC_LGUI,  NAV_SPC,  FN_TAB,                            KC_SPC,             KC_LGUI,  KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT),

    [MAC_FN] = LAYOUT_WRAPPER(TEMPLATE_LAYER),
    ...
    [WIN_FN] = LAYOUT_WRAPPER(TEMPLATE_LAYER),

    [NAV] = LAYOUT_ansi_90(
        KC_MUTE,    KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_INS,             KC_DEL,
        MC_1,       KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_PGUP,
        MC_2,       KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,      KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_PGDN,
        MC_3,       KC_LCTL,  KC_LGUI,  KC_LALT,  KC_LSFT,  KC_LCTL,  KC_G,      KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, _SCLN,    KC_QUOT,            KC_ENT,             KC_END,
        MC_4,       KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_B,     KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   KC_SLSH,  KC_RSFT,  KC_UP,
        QK_BOOT,    KC_LCTL,  KC_LWIN,            KC_LALT,  KC_SPC,   _______,                       KC_SPC,             KC_RALT,  KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT),
